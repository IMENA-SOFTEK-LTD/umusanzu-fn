...
<section
      className={`bg-white w-[90%] mx-auto py-4 rounded-sm`}
    >
      <Button
      ...
      >
        ...
        >
          ...
          <article className='flex flex-col items-center justify-center gap-8 bg-white py-16 w-fit'>
            ...
            <section
              className={`${
                moveHouseholdError || moveHouseholdSuccess ? 'flex w-[50%]' : 'hidden'
              }`}
            >
              <p
                className={`${moveHouseholdError ? 'text-red-500' : 'hidden'}`}
              >
                The household could not be moved successfully. Please refresh
                and try again
              </p>
              <p
                className={`${
        ...
        >
          ...
          >
            The household could not be created successfully. Please refresh and
            try again
          </p>
          <p
            className={`${
            ...
            render={({ field }) => {
              return (
                <Button
                  ...
                  {...field}
                  value={`${
                    createDuplicateHouseholdLoading ? 'Creating...' : 'Create another branch'}`}
                  className="w-full px-6 mx-auto"
                />
              )
            }}
