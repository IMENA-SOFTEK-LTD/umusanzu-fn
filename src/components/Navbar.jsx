        ...
        <form>
          <div class="relative">
            <div class="absolute inset-y-0 flex items-center pl-3 pointer-events-none">
              <svg
                class="w-4 h-4 text-gray-900 dark:text-gray-800"
                aria-hidden="true"
            ...
            <input
              type="search"
              id="default-search"
              class="block p-4 pl-10 text-sm text-gray-900 border border-gray-100 rounded-lg focus:ring-blue-200 focus:border-blue-200 dark:border-gray-400 dark:focus:ring-blue-200 dark:focus:border-blue-200 bg-grey-300"
              placeholder="Search..."
              required
            />
            <button
