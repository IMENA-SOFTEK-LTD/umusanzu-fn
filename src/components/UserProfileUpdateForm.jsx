...
function UserProfileUpdateForm({ user }) {
  ...
  return (
    <div>
      <button
        onClick={openModal}
        className="flex  inline-flex items-center mb-3 items-center justify-center px-4 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-blue-700 to-blue-800 rounded-lg shadow-md hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-300"
        type="button"
      >
