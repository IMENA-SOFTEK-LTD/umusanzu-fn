    ...
    <div className="flex flex-col items-center mt-10">
      <div className=" rounded-lg border shadow-2xl w-8/12  flex flex-col items-center ">
        <div className=" text-center w-96 ">
          <svg
            className="text-gray-800 ml-36 mb-2 h-18 w-24  mt-3"
            aria-hidden="true"
          ...
          <p
            className="mb-3 bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text
                           font-bold "
          >
            {' '}
          ...
          <div className="border shadow-xl rounded-lg mb-10">
            <p className="mb-2 mt-2 font-semibold leading-none text-gray-900 ">
              Phone 1
            </p>
            <p className="mb-4 font-light text-gray-700 sm:mb-5 ">
              {isLoading ? <Loading /> : userProfileData?.data?.phone1}
            </p>
            <p className="mb-2 font-semibold leading-none text-gray-900 ">
              Phone 2
            </p>
            <p className="mb-4 font-light text-gray-700 sm:mb-5 ">
